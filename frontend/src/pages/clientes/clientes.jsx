...
import { ConfirmDialog, ClienteForm, AnimalForm, PORTE_OPTIONS, porteLabel } from "../../components";
import { filtrarClientes } from "../../utils/filtroClientes";
...
function ClienteSearch({ clientes, onClienteSelected, loading }) {
  ...
  // Dropdown só aparece quando há query - preservamos o comportamento original chamando o filtro centralizado e devolvendo [] se a query estiver vazia.
  const filtered = useMemo(() => {
    if (!query.trim()) return [];
    return filtrarClientes(clientes, query);
  }, [clientes, query]);
...
// ClienteForm e AnimalForm foram movidos para frontend/src/components/
// para serem reutilizados em /agendamentos/novo. Aqui são importados.
